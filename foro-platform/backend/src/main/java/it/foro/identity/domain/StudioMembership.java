...
public class StudioMembership {
  ...
  public UUID getId(){return id;} public UUID getStudioId(){return studioId;} public UUID getUserId(){return userId;} public String getRole(){return role;} public String getStatus(){return status;}
}
